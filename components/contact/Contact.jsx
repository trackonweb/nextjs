...
export default function Contact() {
  ...
  return (
    <div className="flex w-full py-10 justify-center items-center mx-auto">
      <div className="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-6 bg-[#0588b0]  xl:mx-20 lg:mx-10 p-4 sm:p-12 lg:rounded-xl  shadow-lg text-white overflow-hidden">
