...
const List = [
  {
    ...
    description: `Upon completion of our Cross-Platform Application Development course get the Benefits of career guidance, Interview preparation, and resources that help you transition smoothly into the professional world.`,
    img: '/virtual-classroom-icon.svg',
  },
  {
    id: 2,
    title: 'Train by Professional',
    description: `Our courses are led by industry who share real-world scenarios, providing you with practical knowledge and a deep understanding of the subject matter`,
    img: '/support-icon.svg',
  },
  {
    id: 3,
    title: 'Hands-on live projects',
    description: `Apply your learning in real-time by working on live projects, honing your skills and preparing you for the challenges of actual app development scenarios`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Internship opportunity',
    description: `we offer an exclusive 3-month free internship after completion, allowing you to deepen your understanding and refine your skills with hands-on experience, all while guided by mentors`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: 'Recognized certification',
    description: `Showcase your proficiency skills with a recognized certification, acknowledged, and respected in the industry, opening doors to exciting opportunities in the field of mobile application development`,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Self-Development',
    description: `We not only focus on your technical skills but also nurture essential soft skills, allowing you to discover the best version of yourself through continuous learning, self-reflection, and guidance`,
  ...
  return (
    <div className=' '>
      <div className='container mx-auto'>
        ...
        Make our Mobile Application Development Course your top choice for modern, feature-rich experiences 
        </h2>
