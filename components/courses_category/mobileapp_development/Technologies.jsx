    ...
    <div className='bg-[#0588b0] text-black '>
     ...
     <div
        ...
        >
          ...
          Attain Proficiency in Mobile Application Tools, Languages, and Frameworks<span className=""></span>
          </h3>
          <span className='text-[16px] lg:text-[20px] font-normal tracking-wide text-[#f3f3f3] text-center'>With the Trackonweb master web development in 2024 course, you will master GitHub, Chrome Developer Tools, VS Code, HTML, CSS, SCSS, Tailwind CSS, Bootstrap, JavaScript (JS), ReactJS, React-Bootstrap, NodeJS, MongoDB, Mongoose, Express JS, APIs, Redux, Middleware, and more.</span>
         
        </div>
        <div  className={`grid gap-5 grid-cols-2 md:grid-cols-4 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6  justify-center items-center  xl:mx-20 lg:mx-10 mx-4 pt-20 pb-20 `}>
           {
