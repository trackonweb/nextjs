...
const List = [
  {
    ...
    description: `Acquire web design skills from seasoned professionals who've contributed to top brands, gaining insights from their vast industry experience.`,
    img: '/virtual-classroom-icon.svg',
  },
  {
    id: 2,
    title: 'Interactive Learning Experience',
    description: `Engage in live classes for real-time interaction with instructors, ensuring an effective and personalized learning journey, distinct from pre-recorded video tutorials.`,
    img: '/support-icon.svg',
  },
  {
    id: 3,
    title: 'Comprehensive Curriculum',
    description: `Benefit from a well-rounded curriculum, meticulously curated by industry experts. Covering fundamental to advanced topics, it provides a thorough understanding of web designing.`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Hands-On Practical Training',
    description: `Immerse yourself in a 100% practical-oriented program, working on diverse projects to design web pages from scratch. This approach ensures a solid foundation for future career success.`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: 'Certification with Free Internship',
    description: `Receive an industry-recognized certificate upon completion from Trackonweb, also our free internship helps you sharpen and practically apply your knowledge. `,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Latest Tools & languages',
    description: `Stay ahead with our web design 2024 course, offering training in the latest web development tools. Master HTML5, CSS, Tailwind CSS, SCSS, with CSS Framework Bootstrap, and more`,
  ...
  return (
    <div className=' '>
      <div className='container mx-auto'>
        ...
        Why Our Responsive Web Design Course in Jaipur is Best?
        </h2>
