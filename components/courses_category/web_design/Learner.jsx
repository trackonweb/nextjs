...
const Learners = [
  {
    ...
    title: "Siddharth",
    description:
      "Exceptional Web Design course! Comprehensive content, hands-on projects, and excellent support. It surpassed my expectations. Highly recommended for anyone serious about mastering web design skills.",
  },
  {
    id: 2,
    title: "Rajendra",
    description:
      "Informative course with a solid foundation. Practical projects and real-world applications. Valuable for beginners and those looking to excel in web design",
  },
  {
    id: 3,
    title: "Sabana",
    description:
      "Enthralling journey into Web Design! Engaging lessons, creative projects, and a supportive community. The course builds a strong foundation and ignites a passion for web creation.",
  },
  {
    id: 4,
    title: "Ramlal Jaat",
    description:
      "Transformative Web Design course! Structured curriculum, interactive projects, and dedicated instructors. It sparked my passion and equipped me with valuable skills. Highly recommended for aspiring web designers.",
  },
       ...
       <div className="container mx-auto">
        ...
        >
          <h3 className="text-white text-center lg:text-[34px] text-[28px] font-[700]">
            What Learners Say About Web Design Course!
          </h3>
        </div>
        <div
