...
const List = [
  {
    ...
    description: `Development focus is a key to success, where we concentrate on learners to enhance their continuous learning, innovation, and adaptability in the ever-evolving business environment.`,
    img: '/virtual-classroom-icon.svg',
  },
  {
    id: 2,
    title: 'latest Tools of web development',
    description: `We give you the best training in the latest web development tools in our 2024 course. Become proficient in using GitHub, Chrome DevTools, VS Code, and AI Tools.`,
    img: '/support-icon.svg',
  },
  {
    id: 3,
    title: 'Industry-demanding Projects',
    description: `Hands-on over 16+ industry-demanded projects, mastering the creation of websites, web apps, e-commerce platforms, and web portals. Sharpen your practical skills through our free internship and complete over 35+ assignments.`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Train by Experts',
    description: `In our web development course, experts will teach you step by step, starting from the basics. You'll learn to create your website and work on the most complex real-world projects.`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: 'Practical Approach',
    description: `Web development may become challenging with limited practical knowledge. Therefore, Trackonweb believes in a practical approach, providing 100% practical knowledge with the utmost clarity.`,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Support and Guidance',
    description: `We stand with learners at every step, providing guidance and support for their continued growth and development. This assistance helps them comprehend complex topics and ensures a solid understanding of concepts.`,
  ...
  return (
    <div className=' '>
      <div className='container mx-auto'>
        <h2 className='lg:text-[34px] text-[28px] font-[600] tracking-wider  text-center leading-10 text-[#2f327d] xl:mx-20 lg:mx-10 mx-4 py-20'>
        Why Choose Our Web Development Training in Jaipur?
        </h2>
