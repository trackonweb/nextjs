...
const Learners = [
  {
    ...
    title: "Rupali",
    description:
      "Outstanding Graphic Design course! Comprehensive content, hands-on projects, and excellent guidance. It exceeded my expectations. Highly recommended for anyone serious about mastering design skills.",
  },
  {
    id: 2,
    title: "Askok Choudhary",
    description:
      "Informative course with a solid foundation. Creative projects and real-world applications. Valuable for beginners and those looking to refine graphic design expertise",
  },
  {
    id: 3,
    title: "Harshit Jain",
    description:
      "Enthralling journey into Graphic Design! Engaging lessons, imaginative projects, and a vibrant community. The course builds a strong foundation and fosters a passion for design.",
  },
  {
    id: 4,
    title: "Amandeep Kaur",
    description:
      "Transformative Graphic Design course! Well-structured curriculum, interactive projects, and dedicated instructors. It ignited my passion and equipped me with valuable skills. Highly recommended for aspiring designers.",
  },
       ...
       <div className="container mx-auto">
        ...
        >
          <h3 className="text-white text-center lg:text-[34px] text-[28px] font-[700]">
            What Learners Say About Graphic Design Course!
          </h3>
        </div>
        <div
