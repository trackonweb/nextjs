        ...
        <div className=' flex flex-col lg:flex-row  justify-start items-center gap-5 xl:mx-20 lg:mx-10 mx-4 pt-20 pb-10'>
          <div className=' lg:w-1/2 w-full flex flex-col justify-start items-start'>
            ...
            <span className='text-white lg:text-[27px] text-[20px] font-bold tracking-wider py-6 capitalize'>
              Elevate Your Creativity: Enroll in Our Graphic Design Course
            </span>
            <span className='text-white text-[16px] leading-7'>
              Enter the vibrant world of graphic design through our
              comprehensive course designed to unlock your creative potential.
              At our institution, we're dedicated to nurturing aspiring
              designers and guiding them towards becoming skilled professionals
              in the dynamic field of visual communication.
              <br />
              <br />
              Embark on a journey to unleash your creative prowess. Join our
              demo class to experience firsthand how our graphic design course
              can expand your artistic abilities and pave the way for a
              successful career in design. Don’t miss this opportunity to refine
              your skills and express your creativity. Enroll now!
            </span>
