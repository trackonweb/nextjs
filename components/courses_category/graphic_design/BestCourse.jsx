...
const List = [
  {
    ...
    description: `Get professional in-depth training in Advanced Graphic designing tools - Adobe Photoshop, Adobe InDesign, Illustrator, Coral Draw, Lightroom, Figma, and Canva.`,
  ...
  },
  {
    ...
    description: `Acquire graphic design skills from Trackonweb professionals to become a master in the field of design. Sharpen your knowledge daily through offline/online regular interactive classes.`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Start From basics',
    description: `Start your journey by fostering creative thinking and transforming mental visuals into tangible designs. Develop the foundational skills needed to bring your ideas to life in the real world.`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: 'Practical Training',
    description: `Experience hands-on learning in graphic design with our practical training program. Work on over 8+ creative and complex tools and hands-on over 12+ Projects. `,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Certification Plus Internship',
    description: `Earn a recognized industry certificate upon course completion at Trackonweb, coupled with a complimentary internship to practically apply and enhance your proficiency in graphic design.`,
  ...
  return (
    <div className=' '>
      <div className='container mx-auto'>
        ...
        Why choose the Trackonweb Advance Graphic Designing course in Jaipur?
        </h2>
