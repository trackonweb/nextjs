...
const List = [
  {
    ...
    description: `Gain proficiency in creating unique user interface and user experience designs through a comprehensive curriculum covering the essential tools and principles of UI/UX design.`,
    img: '/virtual-classroom-icon.svg',
  },
  {
    id: 2,
    title: 'Professional Guidance and Tools Mastery',
    description: `Learn from industry experts and master advanced design tools such as Sketch, Figma, Adobe XD, and Illustrator, ensuring you're equipped with the skills demanded by the evolving design.`,
    img: '/support-icon.svg',
  },
  {
    id: 3,
    title: 'Real-world Project Experience',
    description: `Engage in 14+ basic and advanced projects that provide hands-on experience, allowing you to apply theoretical knowledge to practical scenarios and build a diverse portfolio.`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Internship Guarantee',
    description: `Secure valuable internship opportunities, enhancing your practical skills and gaining exposure to real-world design challenges under the guidance of experienced professionals.`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: 'Comprehensive Assignments',
    description: `Tackle 35+ assignments designed to reinforce your understanding of UI/UX concepts, ensuring a thorough grasp of essential design principles and methodologies.`,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Recognized Certification',
    description: `Upon completion of the course, receive a recognized certificate that attests to your proficiency in UI/UX design, giving you a competitive advancement in the job market.`,
  ...
  return (
    <div className=' '>
      <div className='container mx-auto'>
        ...
        Why opt for our premier UI/UX design course?
        </h2>
