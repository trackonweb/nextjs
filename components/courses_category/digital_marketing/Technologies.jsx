    ...
    <div className='bg-[#0588b0] text-black '>
     ...
     <div
        ...
        >
          ...
          Tools of Digital Marketing you will learn<span className=""></span>
          </h3>
          <span className='text-[16px] lg:text-[20px] font-normal tracking-wide text-[#f3f3f3] text-center'>With Trackonweb You will get the knowledge of 45+ Web and AI Tools including Google Analytics, Google Search Console, Google Ads, Ahrefs, SEMRUSH, SmallSEOTools, YouTube, WordPress, Google Trends, Yoast, Mailchimp, Canva, Moz, ChatGpt & many more. </span>
