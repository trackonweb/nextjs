...
const List = [
  {
    ...
    description: `Benefit from industry-leading classes guided by experienced digital marketing trainers. Learn SEO, Google Ads, Social Media Marketing, and more from seasoned professionals, gaining expertise from India's top mentors.`,
    img: '/virtual-classroom-icon.svg',
  },
  {
    id: 2,
    title: 'Hands-On Internship',
    description: `Upon course completion, seize a complimentary digital marketing internship at our agency. This hands-on experience provides industry exposure, enhancing confidence and practical skills for real-world scenarios.`,
    img: '/support-icon.svg',
  },
  {
    id: 3,
    title: 'Live Projects and Guidance',
    description: `Implement acquired concepts in real-time through live projects, guided by experienced trainers. This practical application ensures a comprehensive understanding of digital marketing strategies and tactics.`,
    img: '/video-courses-icon.svg',
  },
  {
    id: 4,
    title: 'Placement Assistance',
    description: `After successfully completing our 4-month course, we assist in securing your first job. Benefit from Job Interview Preparation, Resume Building, LinkedIn profile development, and more for a successful career launch.`,
    img: '/projects-icon.svg',
  },
  {
    id: 5,
    title: '100% Practical & Concept Clarity',
    description: `Experience hands-on learning at our top digital marketing institute in Jaipur. Our courses prioritize 100% practical application, ensuring clear comprehension and effective concept application.`,
    img: '/job-assistance-icon.svg',
  },
  {
    id: 6,
    title: 'Industry Recognized Certificate',
    description: `Upon completion, receive a certification validating your expertise, enhancing credibility and employability in the competitive digital marketing field.`,
