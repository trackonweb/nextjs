      ...
      <div className="container mx-auto">
        ...
        <div className='grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-between items-center gap-10 xl:px-20 lg:px-10 px-4 py-16'>
            <div className='flex flex-col justify-center lg:items-start items-center gap-5'>
             ...
             <span className='text-[15px] font-medium text-justify leading-7'>Our user centric approach challenges assumptions to define problems & experience</span>
            </div>
            ...
            <div className='flex flex-col justify-center lg:items-start items-center gap-5'>
             ...
             <span className='text-[15px] font-medium text-justify leading-7'>Our team of experts gets off the ground quickly on any technology & cloud</span>
            </div>
            ...
            <div className='flex flex-col justify-center lg:items-start items-center gap-5'>
             ...
             <span className='text-[15px] font-medium text-justify leading-7'>We love to work closely with ourcustomers in a co-creation model</span>
            </div>
        </div>
