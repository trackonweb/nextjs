...
const featuredservices = [
    {
        ...
        description: `Experience unmatched creativity without breaking the bank. Trackonweb Graphic Design services combine brilliance with cost-effectiveness. Maximize your ROI with our streamlined process, ensuring top-quality results within your budget.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Strategic Creativity',
        description: `Fuel your brand vision with Trackonweb creative team. We specialize in original, impactful solutions, ensuring your graphic design project stands out in the digital landscape. Collaborate with us for a uniquely creative and memorable journey.`,
        img: '/creative-process.svg'
    },
    {
        title: '24/7 Help Desk',
        description: `Count on Trackonweb 24/7 Help Desk for uninterrupted assistance. Our committed team ensures seamless operations and offers constant support for your peace of mind. Trust us to be there whenever you need assistance, guiding you through the graphic design process.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Great UI/UX',
        description: `Transform user interactions with Trackonweb great UI/UX designs. Our collaborative efforts between UX strategists, graphic designers, and marketing experts result in innovative design interactions across diverse touchpoints, ensuring a compelling and engaging user experience.`,
        img: '/creative-process.svg'
    },
    {
        title: 'SEO Friendly',
        description: `Turbocharge your website's visibility with Trackonweb SEO-friendly graphic designs. Our in-house SEO experts optimize your visuals for search engines, ensuring increased visibility in relevant search results. Drive traffic and enhance online presence with our effective SEO strategies.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Responsive Design',
        description: `Choose Trackonweb for responsive design that ensures a seamless user experience across devices. Our graphic designers create visually appealing and functional interfaces adaptable to various screens, providing an optimal user experience. Opt for responsiveness with us and enhance user engagement.`,
        img: '/creative-process.svg'
    },
]
