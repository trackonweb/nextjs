...
const featuredservices = [
        ...
        { title: 'Cost-Effective Creative Solutions', description: 'Unlock budget-friendly creativity with Trackonweb. Maximize ROI through streamlined processes and top-quality results. Experience design excellence tailored to your brand.', img: '/creative-process.svg' },
        { title: 'Strategic Design Brilliance', description: 'Fuel your brand vision with Trackonweb creative team. Specializing in impactful solutions for a standout digital presence. Elevate your brand through expertly crafted designs.', img: '/creative-process.svg' },
        { title: '24/7 Support Hub', description: 'Count on Trackonweb 24/7 Help Desk for uninterrupted assistance. Our committed team ensures seamless operations and constant support. Partner with us for reliable and responsive design services.', img: '/creative-process.svg' },
        { title: 'Exceptional User Experience', description: 'Transform user interactions with Trackonweb outstanding designs. Collaborative efforts for innovative interactions across touchpoints. Redefine your digital experience with our UI/UX expertise.', img: '/creative-process.svg' },
        { title: 'SEO-Optimized Visuals', description: 'Turbocharge your website visibility with Trackonweb SEO-friendly designs. In-house SEO experts optimize visuals for increased search engine visibility. Enhance your online presence with our strategic design approach.', img: '/creative-process.svg' },
        { title: 'Responsive Design Excellence', description: 'Choose Trackonweb for responsive design ensuring a seamless user experience. Visually appealing and functional interfaces adaptable to various screens. Let us elevate your brand through cutting-edge design solutions.', img: '/creative-process.svg' },
...
const FeaturedServices = () => {
  return (
    ...
    <div className='container mx-auto'>
      ...
      Choose Trackonweb for Easy and Effective Design Solutions 
      </h2>
