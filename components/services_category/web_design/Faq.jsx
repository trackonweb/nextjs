  ...
  return (
    <div className='bg-[#f3f7fd] '>
      <div className='container mx-auto '>
        <div className=' pt-8'>
          <h3 className='text-[#2f327d] lg:text-[34px] lg:text-center text-start text-[26px] font-[700] leading-10 tracking-wider lg:mx-10 xl:mx-20 mx-4 '>Frequently Asked Questions on Web Design</h3>
