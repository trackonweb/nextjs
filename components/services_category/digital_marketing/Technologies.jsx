  ...
  return (
    <div className='bg-[#fff6f3] text-black py-10'>
      <div className='container mx-auto'>
        ...
        <div
          className={`grid gap-5 grid-cols-3 md:grid-cols-5 sm:grid-cols-5 lg:grid-cols-7 justify-items-center  xl:mx-20 lg:mx-10 mx-4 pt-16 pb-10 `}
        >
          {technologiesList.map((item, index) => {
            return (
              <div
                key={index}
                className='bg-white p-[25px] shadow flex flex-col justify-center items-center gap-3'
              >
                <div>
                  <Image
                    src={item.img}
