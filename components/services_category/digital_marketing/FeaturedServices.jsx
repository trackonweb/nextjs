...
const featuredservices = [
    {
        ...
        description: `Trackonweb understands the importance of optimizing marketing budgets. Their services are designed to provide a cost-effective solution, ensuring that every penny spent translates into measurable results. This cost-efficiency is a key benefit for businesses aiming to achieve a high return on investment.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Enhanced Online Visibility',
        description: `With a focus on SEO optimization and online presence management, Trackonweb ensures that your brand stands out in the crowded digital space. This heightened visibility translates into increased website traffic, brand awareness, and, ultimately, more business opportunities.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Targeted Marketing Strategies',
        description: `Trackonweb employs sophisticated tools and analytics to craft personalized marketing strategies tailored to your specific audience. This ensures that your message reaches the right people at the right time, maximizing engagement and conversion rates.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Social Media Dominance',
        description: `In an age where social media is a powerhouse for brand interaction, Trackonweb crafts compelling social media campaigns. From content creation to community engagement, their services harness the potential of platforms like Facebook, Instagram, Twitter, and LinkedIn to connect with your audience on a deeper level.
    ...
    },
    {
        ...
        description: `The digital landscape is ever-evolving, and Trackonweb stays ahead of the curve. With continuous monitoring of trends and consumer behavior, their team adapts strategies in real-time, ensuring that your brand remains relevant and competitive in the ever-changing digital marketplace.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Reporting and Analysis',
        description: `Transparency is paramount, and Trackonweb excels in providing detailed reports and analyses. This transparency not only keeps you informed about the performance of your digital campaigns but also fosters trust in the partnership.`,
        img: '/creative-process.svg'
    },
]
...
const FeaturedServices = () => {
  return (
    ...
    <div className='container mx-auto'>
      <h2 className='lg:text-[34px] text-[28px] font-[600] tracking-wider  text-center leading-10 text-[#2f327d] xl:mx-20 lg:mx-10 mx-4 py-20 capitalize'>
      Modern Designs, Easy Solutions with  Trackonweb's Graphic Design services – Choose Us and Discover Why! 
      </h2>
      <div className='grid gap-y-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 justify-start items-start xl:mx-20 lg:mx-10 mx-4 '>
      {
        featuredservices.map((item,index)=>{
          return <div key={index} class="section_our_solution">
          <div class="row">
