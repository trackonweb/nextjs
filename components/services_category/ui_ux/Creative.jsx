...
const Creative = () => {
  return (
    ...
    <div className="container mx-auto ">
     ...
     <div className="xl:mx-20 flex lg:flex-row flex-col gap-5 lg:mx-10 mx-4 py-6">
     <div className="lg:w-1/2 w-full">
        <Image src='/ui-graphic-design-services-in-pune-1.png' width={500} height={500} alt=" " className="object-contain"/>
     </div>
     ...
     <button type="button" class="text-white bg-[#0588b0] hover:bg-[#64dfcb]  font-medium rounded-md lg:text-[16px] text-[10px] px-7 py-4 text-center ">{`Work with us`}</button>
