...
const featuredservices = [
        ...
        { title: 'Cost-Effective Creativity', description: 'Unlock budget-friendly creativity with Trackonweb. Maximize ROI through streamlined processes and top-quality results.', img: '/creative-process.svg' },
        { title: 'Strategic Design Brilliance', description: 'Fuel your brand vision with Trackonweb creative team. Specializing in impactful solutions for a standout digital presence.', img: '/creative-process.svg' },
        { title: '24/7 Support Hub', description: 'Count on Trackonweb 24/7 Help Desk for uninterrupted assistance. Our committed team ensures seamless operations and constant support.', img: '/creative-process.svg' },
        { title: 'Exceptional UI/UX Experience', description: 'Transform user interactions with Trackonweb great UI/UX designs. Collaborative efforts for innovative design interactions across touchpoints.', img: '/creative-process.svg' },
        { title: 'SEO-Optimized Visuals', description: 'Turbocharge your websites visibility with Trackonweb SEO-friendly designs. In-house SEO experts optimize visuals for increased search engine visibility.', img: '/creative-process.svg' },
        { title: 'Responsive Design Excellence', description: 'Choose Trackonweb for responsive design ensuring a seamless user experience. Visually appealing and functional interfaces adaptable to various screens.', img: '/creative-process.svg' },
