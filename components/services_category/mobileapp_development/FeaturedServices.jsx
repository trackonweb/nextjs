...
const featuredservices = [
    {
        ...
        description: `Optimize your ROI with Trackonweb's cost-effective approach to mobile app development. Our streamlined process ensures top-quality results within your budget, providing unparalleled affordability without compromising excellence.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Creative Mobile Solutions',
        description: `Ignite your vision with Trackonweb's creative team. Specializing in original, impactful solutions, we ensure your mobile app stands out. Collaborate with us for a uniquely creative digital journey.`,
        img: '/creative-process.svg'
    },
    {
        title: '24/7 Support',
        description: `Uninterrupted assistance awaits at Trackonweb's 24/7 Help Desk. Our committed team ensures seamless operations and offers constant support for your peace of mind. Rely on us for continuous assistance throughout your app development journey.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Exceptional UI/UX Design',
        description: `Our UX strategists, graphic designers, and marketing experts collaborate to craft innovative design interactions across diverse touchpoints, ensuring a compelling and engaging user experience for your mobile app.`,
        img: '/creative-process.svg'
    },
    {
        title: 'SEO Friendly',
        description: `Elevate the visibility of your mobile app with our in-house SEO experts. We optimize your app, making it search engine-friendly and increasing its chances of ranking higher in relevant search results.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Responsive Design',
        description: `Experience seamless user engagement with responsive design from Trackonweb. We craft visually appealing and functional interfaces that adapt to various devices, ensuring an optimal user experience. Choose responsiveness with us for your mobile app development needs.`,
        img: '/creative-process.svg'
    },
]
...
const FeaturedServices = () => {
  return (
    ...
    <div className='container mx-auto'>
      <h2 className='lg:text-[34px] text-[28px] font-[600] tracking-wider  text-center leading-10 text-[#2f327d] xl:mx-20 lg:mx-10 mx-4 capitalize'>
      Sleek Designs, Smooth Solutions withTrackonweb Mobile App Services – Choose Us and Discover Why! 
      </h2>
      <div className='grid gap-y-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 justify-start items-start xl:mx-20 lg:mx-10 mx-4 pt-10'>
      {
