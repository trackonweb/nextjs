  ...
  return (
    <div className='bg-[#fff6f3] text-black py-10'>
     ...
     <div
        ...
        <div  className={`grid gap-5 grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 justify-items-center  xl:mx-20 lg:mx-10 mx-4 pt-16 pb-10 `}>
           {
            technologiesList.map((item,index)=>{
                return  <div key={index} className='bg-white flex-1 p-[25px] shadow flex flex-col justify-center items-center gap-3'>
                <div>
