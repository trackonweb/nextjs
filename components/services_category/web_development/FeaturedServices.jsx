...
const featuredservices = [
    {
        ...
        description: `Maximize Your ROI with Trackonweb's Cost-Effective Approach. Our streamlined process not only ensures top-quality results but also guarantees the success of your project within your budget. Opt for unparalleled affordability without compromising on excellence.`,
    ...
    {
        title: 'Great UI/UX',
        description: `Our UX strategists, graphic designers, and marketing experts collaborate to craft innovative design interactions across diverse touchpoints, ensuring a compelling and engaging user experience.`,
        img: '/creative-process.svg'
    },
    {
        title: 'SEO Friendly',
        description: `Our in-house SEO experts optimize your site, making it search engine-friendly for increased visibility in relevant search results. Elevate traffic to your website with effective SEO strategies.`,
        img: '/creative-process.svg'
    },
    {
        title: 'Responsive Design',
        description: `Experience seamless user engagement with responsive design. We craft visually appealing and functional interfaces that adapt to various devices, ensuring an optimal user experience. Choose responsiveness with us`,
        img: '/creative-process.svg'
    },
]
...
const FeaturedServices = () => {
  return (
    ...
    <div className='container mx-auto'>
      ...
      Elevate Your Digital Presence with Trackonweb's Website Development Services – Choose Us and Discover Why! 
      </h2>
