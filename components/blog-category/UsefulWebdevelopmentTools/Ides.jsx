  ...
  return (
    <div>
       <div className="flex flex-col justify-start items-start  pt-5 pb-5  p-4">
            ...
            <span className="lg:text-[20px] text-[16px] font-semibold tracking-wide ">(a). Front-end Development Tools :-</span>
            ...
            <div className="flex flex-col gap-2 mt-4">
            <span className="lg:text-[20px] text-[16px] font-semibold tracking-wide ">(b). Back-end Development Tools :-</span>
            <ul className="list-disc">
                  <li className="ml-6 pt-3">
