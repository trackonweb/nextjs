    ...
    <div className='bg-[#fff6f3]'>
     <div className='container mx-auto'>
        ...
        <div className='lg:w-1/2 w-full flex flex-col justify-center items-start '>
         ...
         <span className='text-[16px] font-medium text-justify leading-7 pt-3'>To pioneer transformative software solutions that redefine industries, driving innovation, and enhancing global connectivity. We aspire to be a catalyst for technological advancement, envisioning a world where our expertise in software development empowers businesses, fosters growth, and creates sustainable value for all stakeholders.</span>
         <h3 className='text-[#2f327d]  text-[28px] font-[700] pt-4'>Our Mision</h3>
         <span className='text-[16px] font-medium text-justify leading-7 pt-3'>Our mission is to deliver unparalleled software craftsmanship, blending creativity and technology to craft bespoke solutions. We aim to exceed client expectations by prioritizing transparency, embracing flexibility, and upholding the highest standards of quality and professionalism. We strive to empower businesses, fostering long-term success through innovative, tailored software development services"</span>
        </div>
