...
const Services = () => {
  ...
  return (
    <div className={`bg-[url('/layered-waves-haikei.svg')] bg-cover bg-center  py-10 `} >
      <div className="container mx-auto">
        ...
        <button data-ripple-light="true" onClick={handleServices} type="button" className="select-none rounded-lg bg-cyan-600 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-cyan-500/20 transition-all hover:shadow-lg hover:shadow-cyan-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none  focus:bg-cyan-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
      Read More
    </button>
        </div>
        </div>
