    ...
    <div className='bg-white py-10'>
      ...
      <div className={`flex flex-col justify-center items-center space-y-2 py-10 xl:mx-20 lg:mx-10 mx-4`}>
        ...
        <div className="flex flex-col justify-start items-start  gap-[12px] flex-[1 0 0] border  bg-[rgba(255, 255, 255, 0.80)] pb-4 cursor-pointer"
            ...
            <Link href={'/'} className='text-[#0588b0] text-start text-[20px] font-[700] px-5 hover:text-black'>Resources Every Web Developer Should Have</Link>
            ...
            <Link href={'/'} className='px-5 font-medium hover:text-[#0588b0]'>{`Read More > `}</Link>
          </div>
          ...
          <div className="flex flex-col justify-start items-start  gap-[12px] flex-[1 0 0] border  bg-[rgba(255, 255, 255, 0.80)] pb-4 cursor-pointer"
            ...
            <Link href={'/'} className='text-[#0588b0] text-start text-[20px] font-[700] px-5 hover:text-black'>Digital Marketing Demystified: A Comprehensive Overview</Link>
          ...
          <div className="flex flex-col justify-start items-start  gap-[12px] flex-[1 0 0] border  bg-[rgba(255, 255, 255, 0.80)] pb-4 cursor-pointer"
            ...
            <Link href={'/'} className='text-[#0588b0] text-start text-[20px] font-[700] px-5 hover:text-black'>Print Design Perfection: Crafting for Physical Media</Link>
